    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-warning">
                <strong>Selamat Datang di SI Perpustakaan Umum Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Arsip Data Peminjam Buku</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">No. Peminjam</th><th>Nama Peminjam</th><th>Tanggal Pinjam</th><th>Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
