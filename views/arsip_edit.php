<?php
$id=$_GET['id_peminjam'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM datapeminjam WHERE id_peminjam ='$id'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Update Data Peminjam Buku Pada Perpustakaan Umum Kisaran</h3>
                </div>
